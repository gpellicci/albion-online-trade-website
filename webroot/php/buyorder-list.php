...
if(!isset($_COOKIE[$cookie_name])){
	...
	//mysql query
	$sql = "INSERT INTO buyorder (user_id, item, tier, enchant, quality, price, item_localized_name, item_description, quantity, city) VALUES ('$user_id', '$item', '$tier', '$enchant', '$quality', '$price', '$item_localized_name', '$item_description', '$quantity', '$city')";
